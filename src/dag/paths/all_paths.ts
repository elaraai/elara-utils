 ...
 * 
 * **Complexity:** O(V! * P) where V is the number of vertices and P is the average path length.
 * In the worst case, explores all possible paths which can be exponential in dense graphs.
 * 
